...
const DentgoGptHome = () => {
  ...
  useEffect(() => {
    // Clean up any lingering Bootstrap offcanvas backdrop on mount
      ...
      <div className="site_content">
        ...
        <div className="verification-main">
          <div className="container verify-screen-main">
            <div className="Dentgo-home-header">
              <div className="back-btn back-btn2 p-0">
                <Link to="/DentgoGptHome">
              ...
              <div className="notification-bell-main">
                <Link to="/Notification">
                  <svg
                    ...
                    fill="none"
                  >
                    <mask id="mask0_3_4211" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                ...
                >
                  <svg
                    ...
                    fill="none"
                  >
                    <mask id="mask0_3_4206" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                      <rect width="24" height="24" fill="white" />
                    </mask>
          ...
          <div className="verify-section-main align-items-stretch h-100">
            <div className="Dentgo-box-main">
              <div className="plus-box-text-main">
                <h4 className="Dentgo-pluse-text">Dentgo Plus</h4>
                <h4 className="unlock">Unlock Dentgo premium to unlock all features.</h4>
            ...
            <div className="print-continue-btn-head">
              <div className="bottom-fix-btn onboarding-next-btn-home" onClick={handleSignIn}>
                <Link to="/DentgoChat">Start Chat with Dentgo</Link>
              </div>
            </div>
          </div>
        </div>
        {/* <!-- ====================================== Dentgo Home Screen End ===================================== --> */}
              ...
              <div className="setting-opestion-main setting-opestion-space">
                <div className="setting-opestion-main-sub">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"
                    fill="none">
                    <rect opacity="0.08" width="48" height="48" rx="8" fill="#0078D7" />
                    <g>
                      <path d="M24 17V31" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M17 24H31" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                    </g>
                  </svg>
              ...
              <div className="setting-opestion-main setting-opestion-space">
                <div className="setting-opestion-main-sub">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"
                    ...
                    <rect opacity="0.08" width="48" height="48" rx="8" fill="#0078D7" />
                    <g>
                      <path d="M24 20V24L26 26" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path
                        ...
                        stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                    </g>
                  </svg>
              ...
              <div className="setting-opestion-main setting-opestion-space">
                <div className="setting-opestion-main-sub">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"
                    ...
                    <rect opacity="0.08" width="48" height="48" rx="8" fill="#0078D7" />
                    <g>
                      <path d="M15 33H33" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M15 22H33" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M17 18L24 15L31 18" stroke="#0078D7" strokeWidth="2"
                        strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M16 22V33" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M32 22V33" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M20 26V29" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M24 26V29" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M28 26V29" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                    </g>
                  </svg>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"
                    ...
                    <g>
                      ...
                      <path
                        ...
                        stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M17 27V28M17 20V21" stroke="#0078D7" strokeWidth="2"
                        strokeLinecap="round" strokeLinejoin="round" />
                    </g>
                  </svg>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"
                    ...
                    <g>
                      <path
                        ...
                        stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M24 15V18M24 30V33" stroke="#0078D7" strokeWidth="2"
                        strokeLinecap="round" strokeLinejoin="round" />
                    </g>
                  </svg>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"
                    ...
                    <g>
                      <path
                        ...
                        stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M24 20H24.01" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M23 24H24V28H25" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                    </g>
                  </svg>
                  <h2 className="smith new-chat">Terms and Privacy</h2>
                </div>
                <i className="ri-arrow-right-s-line"></i>
              </div>
            </Link>
            ...
            <div className="setting-opestion-main setting-opestion-space">
              <div className="setting-opestion-main-sub">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                  <rect opacity="0.08" width="48" height="48" rx="8" fill="#0078D7" />
                  <g>
                    <path d="M24 26C25.1046 26 26 25.1046 26 24C26 22.8954 25.1046 22 24 22C22.8954 22 22 22.8954 22 24C22 25.1046 22.8954 26 24 26Z" stroke="#0078D7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M34 24C31.333 28.667 28 31 24 31C20 31 16.667 28.667 14 24C16.667 19.333 20 17 24 17C28 17 31.333 19.333 34 24Z" stroke="#0078D7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </g>
                </svg>
              ...
              <div className="setting-opestion-main setting-opestion-space">
                <div className="setting-opestion-main-sub">
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"
                    ...
                    <rect opacity="0.08" width="48" height="48" rx="8" fill="#0078D7" />
                    <g>
                      <path d="M21 23C23.2091 23 25 21.2091 25 19C25 16.7909 23.2091 15 21 15C18.7909 15 17 16.7909 17 19C17 21.2091 18.7909 23 21 23Z" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M15 33V31C15 29.9391 15.4214 28.9217 16.1716 28.1716C16.9217 27.4214 17.9391 27 19 27H23C24.0609 27 25.0783 27.4214 25.8284 28.1716C26.5786 28.9217 27 29.9391 27 31V33" stroke="#0078D7" strokeWidth="2" strokeLinecap="round"
                        strokeLinejoin="round" />
                      <path d="M28 23H34M31 20V26" stroke="#0078D7" strokeWidth="2"
                        strokeLinecap="round" strokeLinejoin="round" />
                    </g>
                  </svg>
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"
                    ...
                    <g>
                      <path d="M22 22L26 26M26 22L22 26" stroke="#FF484D" strokeWidth="2"
                        strokeLinecap="round" strokeLinejoin="round" />
                      <path d="M24 15C31.2 15 33 16.8 33 24C33 31.2 31.2 33 24 33C16.8 33 15 31.2 15 24C15 16.8 16.8 15 24 15Z" stroke="#FF484D"
                        strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </g>
                  </svg>
                  <h2 className="smith new-chat">Delete Account</h2>
                </div>
                <i className="ri-arrow-right-s-line"></i>
              </div>
            </Link>
        ...
        <div className="offcanvas offcanvas-bottom" tabIndex="-1" id="offcanvasBottom">
          ...
          <div className="offcanvas-body small">
            ...
            <div className="logout-button-main">
              <button className="logout-cancel" data-bs-dismiss="offcanvas" aria-label="Close">
                Cancel
              </button>
              <button
                type="button"
          ...
          <div className="popup-container">
            ...
            <div className="delayedPopupWindow">
              ...
              <div className="formDescription">
                ...
                <h3>Dentgo AI Chatbot</h3>
                <p>Add the Dentgo Dental AI Assistant to your home screen for fast, seamless access—just like a regular app.</p>
