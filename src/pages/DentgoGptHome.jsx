        ...
        <div className="mx-auto max-w-lg px-4">
          <div className="flex items-center justify-between pt-8">
            <div className="flex items-center">
              <Link to="/DentgoGptHome" className="p-0">
                <img src={logo} alt="Logo" className="h-8 w-auto" />
              </Link>
              <h1 className="text-white text-lg font-medium leading-6 pl-3">Dentgo</h1>
            </div>
            <div className="flex items-center gap-2 relative">
              <Link to="/Notification" className="relative">
                ...
                <div className="absolute -top-1 right-9 w-4 h-4 flex items-center justify-center rounded-full bg-red text-white text-xs">
                  5
                </div>
              </Link>
              <button
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="none"
                  className="h-6 w-auto text-white stroke-current"
                >
          ...
          <div className="bg-white mt-5 rounded-t-3xl px-4 flex flex-col h-[calc(100vh-90px)] overflow-y-auto">
            <div className="bg-white flex items-center justify-between rounded-xl mb-5 p-4">
              <div className="pl-3 py-3">
                <h4 className="text-2xl font-semibold leading-9 text-gray-800">Dentgo Plus</h4>
                <h4 className="text-gray-500 text-base font-medium leading-6">
                  Unlock Dentgo premium to unlock all features.
                </h4>
                <button
                  className="mt-4 px-4 py-3 bg-gray-100 rounded-lg text-blue text-base font-medium"
              ...
              <div className="flex h-full">
                <img src={plusRobot} alt="plus-robot" className="rounded-bl-xl max-w-full h-auto" />
              </div>
            </div>
            <div className="flex flex-col items-center justify-center">
              <div
                className="w-full bg-white text-blue font-sans text-lg font-medium rounded-xl py-4 my-4 flex justify-center items-center cursor-pointer"
          ...
          >
            <div className="flex items-center justify-center p-4">
              <h5 className="text-gray-800 font-sans text-base font-medium leading-6">
                Settings
              </h5>
              <button
                type="button"
            ...
            <div className="p-4 space-y-4">
                ...
                <div className="flex items-center justify-between py-2 border-b border-gray-200">
                  <div className="flex items-center gap-4">
                    <svg
                      ...
                      viewBox="0 0 48 48"
                      fill="none"
                      className="h-12 w-12 text-blue stroke-current"
                    >
                    ...
                    <h2 className="text-gray-800 font-sans text-base font-medium leading-6">
                      New Chat
                    </h2>
                  </div>
                  <i className="ri-arrow-right-s-line text-gray-800 text-2xl"></i>
                </div>
              </Link>
              <Link to="/History">
                <div className="flex items-center justify-between py-2 border-b border-gray-200">
              ...
              <Link to="/Currency">
                <div className="flex items-center justify-between py-2 border-b border-gray-200">
                  ...
                  <p className="text-gray-500 text-base leading-5 pl-14">USD</p>
                  <i className="ri-arrow-right-s-line text-gray-800 text-2xl"></i>
                </div>
              </Link>
              ...
              <div className="flex items-center justify-between py-2 border-b border-gray-200">
                <div className="flex items-center gap-4">
                  <svg
                    ...
                    viewBox="0 0 48 48"
                    fill="none"
                    className="h-12 w-12 text-red stroke-current"
                  >
                    <rect opacity="0.08" width="48" height="48" rx="8" fill="currentColor" />
                    <g>
                      <path
          ...
          <div className="offcanvas offcanvas-bottom" tabIndex="-1" id="offcanvasBottom">
            ...
            <div className="p-4 text-center">
              <h2 className="text-gray-800 font-sans text-xl font-semibold leading-7 pb-4">
                Logout
              </h2>
              <p className="text-gray-500 font-sans text-lg font-medium leading-6 pb-6">
                Are you sure you want to log out?
              </p>
              <div className="flex justify-center items-center gap-4">
                <button
                  className="bg-white text-blue font-sans text-lg font-medium leading-6 py-4 px-8 rounded-xl"
                  data-bs-dismiss="offcanvas"
                  aria-label="Close"
                >
                  Cancel
                ...
                <button
                  type="button"
                  className="bg-blue text-white font-sans text-lg font-medium leading-6 py-4 px-6 rounded-xl"
                  onClick={async () => {
                    await logout();
          ...
          {isVisible && (
            <>
              <div className="fixed inset-0 bg-black opacity-50 z-50" onClick={hidePopup}></div>
              <div className="fixed bottom-0 left-0 w-full bg-white z-60 p-4 rounded-t-3xl max-w-lg mx-auto">
                <Link
                  to="#"
                  id="btnClose"
                  onClick={hidePopup}
                  className="absolute top-2 right-2 text-blue text-3xl"
                >
                  <i className="ri-close-fill"></i>
                </Link>
                <div className="text-center pt-8">
                  <img src={logo} alt="logo" className="mx-auto w-24 h-24" />
                  <h3 className="text-gray-800 text-2xl font-semibold py-4">
                    Dentgo AI Chatbot
                  </h3>
                  <p className="mb-4 text-base leading-6 font-sans text-gray-500 text-center px-2">
                    Add the Dentgo Dental AI Assistant to your home screen for fast, seamless access—just like a regular app.
                  </p>
                  <div className="flex items-center justify-center">
                    <button className="flex items-center bg-blue text-white text-lg px-6 py-3 rounded-lg cursor-pointer">
                      Add Home Screen
