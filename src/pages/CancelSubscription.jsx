            ...
            <div className="verification-main">
                <div className="container verify-screen-main p-0">
                    <div className="back-btn back-btn2">
                        ...
                        <h1>Dentgo GPT Plus Subscription</h1>
                    </div>
                    <div className="verify-section-main align-items-stretch">
                        <div className="main-text-group">
                            <h2 className="hey-jessica gpt-plus">Dentgo GPT Plus</h2>

                            <div className="premium-features-main">
                                <div>
                                    <svg className="premium-svg" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                                ...
                                <div>
                                    ...
                                    <p className="sub-text access">
                                        Plus subscribers have access to Dentgo GPT Pro and our latest beta features.
                                    </p>
                                </div>
                            </div>
                                ...
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                                        <path d="M15 15C17.5 11.3 15 6.25 13.75 5C13.75 8.7975 11.5337 10.9263 10 12.5C8.4675 14.075 7.5 16.55 7.5 18.75C7.5 20.7391 8.29018 22.6468 9.6967 24.0533C11.1032 25.4598 13.0109 26.25 15 26.25C16.9891 26.25 18.8968 25.4598 20.3033 24.0533C21.7098 22.6468 22.5 20.7391 22.5 18.75C22.5 16.835 21.18 13.825 20 12.5C17.7675 16.25 16.5112 16.25 15 15Z"
                                            stroke="#FF484D" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                    </svg>
                                </div>
                                <div>
                        ...
                        <div className="print-continue-btn-head">
                            ...
                            <div className="onboarding-next-btn-Subscribe bottom-fix-btn">
                                <Link to="/LetYouIn">Cancel My Subscription</Link>
                            </div>
                        </div>
                    </div>
                </div>
