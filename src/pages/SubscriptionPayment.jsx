...
const PaymentRequestSection = () => {
  ...
  return (
    <div className="subscription-pr-button">
      <PaymentRequestButtonElement
        options={{
          paymentRequest,
          style: {
          ...
          <div className="container verify-screen-main p-0">
            ...
            <div className="verify-section-main align-items-stretch">
              <div className="subscription-Dentgo-logo-main">
                <img
                  className="subscription-Dentgo-logo"
                  src={logo}
                  alt="logo"
                />
              </div>
              ...
              <p className="sub-text subscription-date">
                Subscription Due at 15 Dec 2024
              </p>
              <h2 className="twinty-five">$25.00</h2>
              <p className="sub-text bank-card">
              ...
              {/* Manual fallback: choose saved payment */}
              <p className="sub-text bank-card">
              ...
              <div className="promo-code-main">
                <p className="sub-text bank-card promo-code">
                  Promo Code
                </p>
              ...
              <div className="modal-body">
                ...
                <form>
                  ...
                  <div className="form-check border-bottom px-0 custom-radio">
                    ...
                    />
                    <label
                      className="form-check-label checkout-modal-lbl-payment"
                      htmlFor="Payment1"
                    >
                      <span className="payment-type">
                        <svg
                      ...
                      <div className="card-text-america">
                        ...
                        <div className="america-card-number">
                          <span className="america-card-active">
                            Active
                          </span>{" "}
                          | Card Number **** 4625
                        </div>
                  ...
                  <div className="form-check border-bottom px-0 custom-radio">
                    ...
                    >
                      ...
                      <div className="card-text-america">
                        ...
                        <div className="america-card-number">
                          <span className="america-card-inactive">
                            Inactive
                          </span>{" "}
                          | Card Number **** 2540
                        </div>
