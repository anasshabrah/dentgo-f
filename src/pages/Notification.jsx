                        ...
                        <div className="verify-section-main align-items-stretch">
                            <div className="notification-security-box">
                                <div className="notification-security-box-sub">
                                    ...
                                    <div className="">
                                        <h2 className="security-update-text">Security Updates!</h2>
                                        <p className="today-text">Today | 09:24 AM</p>
                                    </div>
                                </div>
                                <button className="new-btn">New</button>
                            </div>
                            <p className="today-text factor">Now Dentgo GPT has a Two-Factor Authentication. Try it now to make your
                                account more secure.
                            </p>
                            <div className="notification-security-box">
                                <div className="notification-security-box-sub">
                                    ...
                                    <div>
                                        <h2 className="security-update-text">Multiple Card Features!</h2>
                                        <p className="today-text">1 day ago | 14:43 PM</p>
                                    </div>
                                </div>
                                <button className="new-btn">New</button>
                            </div>
                            <p className="today-text factor">Now you can also connect Dentgo GPT with multiple MasterCard & Visa. Try
                                the service now.
                            </p>
                            <div className="notification-security-box">
                                <div className="notification-security-box-sub">
                                    ...
                                    <div>
                                        <h2 className="security-update-text">New Updates Available!</h2>
                                        <p className="today-text">2 days ago | 10:24 AM</p>
                                    </div>
                                </div>
                            </div>
                            <p className="today-text factor">Update Dentgo GPT now to get access to the latest features for easier in
                            ...
                            <div className="notification-security-box">
                                <div className="notification-security-box-sub">
                                    ...
                                    <div>
                                        <h2 className="security-update-text">Account Setup Successful!</h2>
                                        <p className="today-text">10 Dec, 2023 | 14:24 AM</p>
                                    </div>
                                </div>
                            </div>
                            <p className="today-text factor border-bottom-0 history-bottom">Your account creation is successful, you
